     ...
     *   };\
        ...
        function template(text, data, options) {
            ...
            text.replace(reDelimiters, function(match, escapeValue, interpolateValue, esTemplateValue, evaluateValue, offset) {
                ...
                //template with undefined values fix
                if (data && interpolateValue) {
                    var interArr = interpolateValue.split('.');
                    _.each(interArr, function(obj, index) {
                        if (data[obj]==undefined) {
                            data[obj]={};
                            if (index+1==interArr.length) {
                                data[obj]='';
                            }
                        }
                    });
